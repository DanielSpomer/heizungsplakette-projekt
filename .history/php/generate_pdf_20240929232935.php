...
// Logik für efh und zentralheizung
$isEfh = in_array($formData['immobilientyp'], ['Einfamilienhaus', 'Einfamilienhaus mit Einliegerwohnung']);
$isZentralheizung = $formData['heizsystem'] === 'Zentralheizung';
...
$data = [
    ...
    'zentralheizung' => $isZentralheizung,
