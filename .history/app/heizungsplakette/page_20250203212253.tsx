    ...
    if (currentStep === 3) {
      const loadCopecartScript = () => {
        return new Promise<void>((resolve, reject) => {
          ...
          script.src = 'https://copecart.com/packs/js/default~checkout/eu/main~checkout/us/main~shop_checkout/eu/main~shop_checkout/us/main-b254f39878e260a11503.chunk.js';
          script.async = true;
          script.onload = () => {
      ...
      return () => {
        const scriptToRemove = document.querySelector('script[src="https://copecart.com/packs/js/default~checkout/eu/main~checkout/us/main~shop_checkout/eu/main~shop_checkout/us/main-b254f39878e260a11503.chunk.js"]');
        if (scriptToRemove) {
