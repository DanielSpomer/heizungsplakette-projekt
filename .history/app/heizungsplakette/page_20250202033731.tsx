...
export default function HeizungsplaketteMaske() {
  ...
  useEffect(() => {
    if (currentStep === 3) {
      ...
      // Setze einen Timer, um das Skript erneut zu laden, falls es beim ersten Mal fehlschlägt
      const retryTimer = setTimeout(() => {
        if (!copecartScriptLoaded) {
          console.log('Versuche, das Copecart-Skript erneut zu laden...');
          loadCopecartScript();
        }
      }, 5000); // Versuche nach 5 Sekunden erneut
  ...
  }, [currentStep, copecartScriptLoaded]);
                  ...
                  <div id="copecart-checkout-795e1d47" className="w-full">
                    {copecartScriptLoaded ? (
                      ...
                      <div className="text-center">
                        <p className="text-gray-600 mb-2">Das Zahlungsformular konnte nicht geladen werden.</p>
