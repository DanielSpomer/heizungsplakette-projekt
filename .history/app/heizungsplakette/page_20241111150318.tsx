...
export default function HeizungsplaketteMaske() {
  ...
  const [formData, setFormData] = useState({
    ...
    personOrt: '',
    istEigentuemer: '',
    bedienungsanleitungFoto1: null as File | null,
    bedienungsanleitungFoto2: null as File | null,
    bedienungsanleitungFoto3: null as File | null,
    bedienungsanleitungFoto4: null as File | null,
    heizungsetiketteFoto1: null as File | null,
    heizungsetiketteFoto2: null as File | null,
    ...
    verzichtAufHeizungslabelFoto: false,
    verzichtAufHeizungsanlageFoto: false,
  ...
  const validateStep = (step: number) => {
    ...
    if (step === 1) {
      ...
      if (!formData.verzichtAufBedienungsanleitungFotos && 
          !formData.bedienungsanleitungFoto1 && 
          !formData.bedienungsanleitungFoto2 && 
          !formData.bedienungsanleitungFoto3 && 
          !formData.bedienungsanleitungFoto4) {
      ...
      if (!formData.verzichtAufHeizungsetiketteFotos && 
          !formData.heizungsetiketteFoto1 && 
          !formData.heizungsetiketteFoto2) {
      ...
      if (!formData.verzichtAufHeizungslabelFoto && !formData.heizungslabelFoto) {
        newErrors.heizungslabelFoto = "Bitte laden Sie ein Foto des Heizungslabels hoch oder verzichten Sie ausdrücklich darauf."
      }
      if (!formData.verzichtAufHeizungsanlageFoto && !formData.heizungFoto) {
        newErrors.heizungFoto = "Bitte laden Sie ein Foto der Heizungsanlage hoch oder verzichten Sie ausdrücklich darauf."
      }
    } else if (step === 7) {
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {currentStep === 6 && (
              <>
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="text-lg font-semibold">Bedienungsanleitung (1. - 4. Seite)</h3>
                    {!formData.verzichtAufBedienungsanleitungFotos && (
                      <div className="space-y-2">
                        <Input type="file" onChange={handleFileChange('bedienungsanleitungFoto1')} accept="image/*,.heic" />
                        <Input type="file" onChange={handleFileChange('bedienungsanleitungFoto2')} accept="image/*,.heic" />
                        <Input type="file" onChange={handleFileChange('bedienungsanleitungFoto3')} accept="image/*,.heic" />
                        <Input type="file" onChange={handleFileChange('bedienungsanleitungFoto4')} accept="image/*,.heic" />
                      </div>
                    )}
                  ...
                  <div>
                    <h3 className="text-lg font-semibold">Heizungsetikette (1. und 2. Seite)</h3>
                    {!formData.verzichtAufHeizungsetiketteFotos && (
                      <div className="space-y-2">
                        <Input type="file" onChange={handleFileChange('heizungsetiketteFoto1')} accept="image/*,.heic" />
                        <Input type="file" onChange={handleFileChange('heizungsetiketteFoto2')} accept="image/*,.heic" />
                      </div>
                    )}
                    <div className="flex items-center space-x-2 mt-2">
                      <Checkbox
                      ...
                      <Label htmlFor="verzichtAufHeizungsetiketteFotos">
                        Ich verzichte ausdrücklich auf das Bereitstellen von Fotos der Heizungsetikette
                      </Label>
                    </div>
                  ...
                  <div>
                    ...
                    {!formData.verzichtAufHeizungslabelFoto && (
                      <div className="space-y-2">
                        <Input type="file" onChange={handleFileChange('heizungslabelFoto')} accept="image/*,.heic" />
                      </div>
                    )}
                    <div className="flex items-center space-x-2 mt-2">
                      <Checkbox
                        id="verzichtAufHeizungslabelFoto"
                        checked={formData.verzichtAufHeizungslabelFoto}
                        onCheckedChange={handleCheckboxChange('verzichtAufHeizungslabelFoto')}
                      />
                      <Label htmlFor="verzichtAufHeizungslabelFoto">
                        Ich verzichte ausdrücklich auf das Bereitstellen eines Fotos des Heizungslabels
                      </Label>
                    </div>
                  ...
                  <div>
                    ...
                    {!formData.verzichtAufHeizungsanlageFoto && (
                      <div className="space-y-2">
                        <Input type="file" onChange={handleFileChange('heizungFoto')} accept="image/*,.heic" />
                      </div>
                    )}
                    <div className="flex items-center space-x-2 mt-2">
                      <Checkbox
                        id="verzichtAufHeizungsanlageFoto"
                        checked={formData.verzichtAufHeizungsanlageFoto}
                        onCheckedChange={handleCheckboxChange('verzichtAufHeizungsanlageFoto')}
                      />
                      <Label htmlFor="verzichtAufHeizungsanlageFoto">
                        Ich verzichte ausdrücklich auf das Bereitstellen eines Fotos der Heizungsanlage
                      </Label>
                    </div>
