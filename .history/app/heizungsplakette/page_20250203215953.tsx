...
export default function HeizungsplaketteMaske() {
  ...
  const [stripeIframeLoaded, setStripeIframeLoaded] = useState(false);
            ...
            {currentStep === 3 && (
              <>
                ...
                <div className="space-y-4">
                  ...
                  <div className="w-full min-h-[600px] border rounded-lg p-4">
                    {stripeError ? (
                      ...
                      <iframe
                        src="https://buy.stripe.com/test_3cs7uWc5I2Pi9oY7ss"
                        width="100%"
                        height="600px"
                        frameBorder="0"
                        allow="payment"
              ...
              <>
                ...
                <div className="space-y-4">
                  ...
                  {addressValidationMessage && (
                    <Alert variant={addressValidationMessage.includes("erfolgreich") ? "default" : "destructive"}>                      <AlertTitle>Adressvalidierung</AlertTitle>
