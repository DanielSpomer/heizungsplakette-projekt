...
export default function HeizungsplaketteMaske() {
  ...
  useEffect(() => {
    if (currentStep === 3) {
      ...
      const existingScript = document.querySelector('script[src="https://cdn.copecart.com/js/embed.js"]');
      if (existingScript) {
      ...
      script.async = true;
      script.onload = () => {
        // Initialize Copecart after script loads
                ...
                <div className="space-y-4">
                  ...
                  <div id="copecart-checkout-795e1d47" className="w-full">
                    {copecartScriptLoaded ? (
                      ...
                      <p className="text-center text-gray-600">Bitte warten Sie, während das Zahlungsformular geladen wird...</p>
                    )}
                  </div>
