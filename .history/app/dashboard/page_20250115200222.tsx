...
export default function DashboardPage() {
  ...
  const handleSave = async () => {
    if (editingItem) {
      ...
      try {
        ...
        await fetchHeizungsplaketten(); // Neu laden der Daten nach dem Speichern
        setEditingItem(null);
        toast({
          title: "Gespeichert",
  ...
  const handleApprove = async (id: number) => {
    ...
    try {
      ...
      await fetchHeizungsplaketten(); // Neu laden der Daten nach der Genehmigung
      toast({
        title: "Genehmigt",
  ...
  const handleReject = async (id: number) => {
    ...
    try {
      ...
      await fetchHeizungsplaketten(); // Neu laden der Daten nach der Ablehnung
      toast({
        title: "Abgelehnt",
              ...
              {editingItem && (
                <div className="grid gap-4 py-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <Label htmlFor="artDerImmobilie">Artder Immobilie</Label>
                      <Select
