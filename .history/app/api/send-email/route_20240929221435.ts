...
Ist Eigentümer: ${formData.istEigentuemer}
    ...
    const mailOptions = {
      ...
      vielen Dank, dass Sie sich für den Erwerb der Heizungsplakette entschieden haben. Im Anhang finden Sie eine Zusammenfassung Ihrer Angaben sowie die generierte Heizungsplakette als PDF.
