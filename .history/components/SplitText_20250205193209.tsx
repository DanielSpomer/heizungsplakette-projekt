...
type EasingType = 'default' | 'gentle' | 'wobbly' | 'stiff' | 'slow' | 'molasses';
...
const SplitText: React.FC<SplitTextProps> = ({
  ...
  const springs = useSprings(
    ...
    letters.map((_, i) => ({
      ...
      delay: i * delay,
      config: config[easing as keyof typeof config],
    }))
  );
          ...
          {word.map((letter, letterIndex) => {
            ...
            return (
              <animated.span
                key={index}
                style={{
                  ...(springs[index] as { [key: string]: SpringValue<string | number> }),
